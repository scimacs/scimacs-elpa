...
(autoload 'jupyter-tramp-file-name-p "jupyter-tramp" "\
...
;;;***

;;;### (autoloads nil "jupyter-zmq-channel-comm" "jupyter-zmq-channel-comm.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from jupyter-zmq-channel-comm.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jupyter-zmq-channel-comm" '("jupyter-zmq-channel-comm")))
